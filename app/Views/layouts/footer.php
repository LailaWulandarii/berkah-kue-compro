...
<footer class="custom-footer">
		<div class="footer-container">
				...
				<div class="footer-logo-container">
					<div class="footer-logo">
                        <a href="<?= base_url($lang . '/') ?>">
                            <img src="<?= base_url('assets/img/profil/' . $profil['logo_perusahaan']); ?>" alt="<?= $lang == 'id' ? $profil['alt_logo_perusahaan_id'] : $profil['alt_logo_perusahaan_en']; ?>">
                        </a>
                    </div>
				</div>
			...
			<div class="footer-bottom">
				<p>© Copyright TokoBerkahKueAbadi 2025</p>
			</div>
		</div>
</footer>